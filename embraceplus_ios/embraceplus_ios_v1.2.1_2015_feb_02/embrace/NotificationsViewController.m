...
//
// Edited by Vincent Kahn on June 13th, 2015
//
//
...
//        notificationTitles = [[NSMutableArray alloc]initWithContentsOfFile:s];
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:[FilePath notificationIsTheatreFilePath]])
    {
        
        notificationIsTheatre = [[NSMutableArray alloc]initWithContentsOfFile:[FilePath notificationIsTheatreFilePath]];
    }
    ...
    [notificationIsTheatre writeToFile:[FilePath notificationIsTheatreFilePath] atomically:YES];
